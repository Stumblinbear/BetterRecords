		...
		if(player.isSneaking()) {
			if(world.getBlock(x, y + 1, z) == Blocks.air) {
				...
				if(tileEntityRecordPlayer.opening)
					world.playSoundEffect(x, (double)y + 0.5D, z, "random.chestopen", 0.5F, world.rand.nextFloat() * 0.2F + 3F);
				else
					world.playSoundEffect(x, (double)y + 0.5D, z, "random.chestclosed", 0.5F, world.rand.nextFloat() * 0.2F + 3F);
			}
