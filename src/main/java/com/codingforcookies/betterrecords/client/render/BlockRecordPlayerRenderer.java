...
public class BlockRecordPlayerRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale, int destroyStage) {
        ...
        GL11.glPushMatrix();
        {
            ...
            bindTexture(StaticInfo.modelRecordPlayerRes);
            StaticInfo.modelRecordPlayer.render(null, tileEntityRecordPlayer.openAmount, tileEntityRecordPlayer.needleLocation, tileEntityRecordPlayer.recordRotation, 0.0F, 0.0F, 0.0625F);
        }
        GL11.glPopMatrix();
    }
}
